...
class OnlineTest extends JFrame implements ActionListener {
    ...
    OnlineTest(String s) {
        super(s);
        getContentPane().setBackground(Color.LIGHT_GRAY); // Setting background color of the frame

        l = new JLabel();
        l.setForeground(Color.BLUE); // Setting text color of the label
        add(l);

        bg = new ButtonGroup();
        for (int i = 0; i < 5; i++) {
            jb[i] = new JRadioButton();
            jb[i].setBackground(Color.WHITE); // Setting background color of radio buttons
            add(jb[i]);
            bg.add(jb[i]);
        }

        b1 = new JButton("Next");
        b1.setBackground(Color.GREEN); // Setting background color of 'Next' button
        b2 = new JButton("Bookmark");
        b2.setBackground(Color.ORANGE); // Setting background color of 'Bookmark' button
...
public void actionPerformed(ActionEvent e)
    ...
    {
        new OnlineTest("Test Java Online");
    }
